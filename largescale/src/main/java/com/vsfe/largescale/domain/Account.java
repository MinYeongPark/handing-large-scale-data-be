...
public class Account {
	...
	public boolean validateAccountNumber() {
		...
		var secondPartSum = getValidateSum(accountTokens[1]);
		var thirdPartSum = getValidateSum(accountTokens[2].substring(0, accountTokens[2].length() - 1));

		return (secondPartSum + thirdPartSum) % 10 == (accountTokens[2].charAt(accountTokens[2].length() - 1)) - '0';
	}
